...
import { Plus, Pencil, Trash2, GripVertical, Paintbrush, Home, Droplets, Shield, Palette } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Hizmet Yonetimi</h1>
          <p className="text-muted-foreground">Sundugunuz hizmetleri yonetin</p>
        </div>
